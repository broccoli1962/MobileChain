...
public class TouchPanel : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                //panel click
                if (ray.transform.CompareTag("Panel") && !playerSystem.turn || ray.transform.CompareTag("CLPanel") && !playerSystem.turn || ray.transform.CompareTag("CPanel") && !playerSystem.turn)
                {
